...
import com.jsonreader.YearMakeModelReaderFromXLS;
...
public class UploadYearMakeModel {
    ...
    public static final String SAMPLE_XLSX_FILE_PATH = "D:\\knowledgebase\\myproject\\twilio\\documents\\DataFull\\FINAL\\MASTER_YEAR_MAKE_MODEL.xlsx";
    
	  public static void main(String[] args) {
		  //2020-07-29 15:31:29 INFO  UploadYearMakeModel:52 - YearMakeModelXLSDTO {year:2015, make:HYUNDAI, model:SONATA}
		  UploadYearMakeModel instance	=	new UploadYearMakeModel();
	    	...
	    	try {
	    		...
	    		for (YearMakeModelXLSDTO object : yearMakeModelList) {
	    			...
	    			row.setSheetMakeStr(object.getMake());
	    			row.setSheetModelStr(object.getModel());
	    			row.setSheetYearStr(new Integer(object.getYear()).toString());
	    			clt.insertDocToYMM(row);
	    			logger.info(object);
				}
