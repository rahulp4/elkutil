...
public class JsonReader {
	...
	public String baseFileDir	=	"/var/config/DataPul/data/";	  
...
//	  String modifiedSheetCategory	=	sheetCategory.replaceAll("|", " ");
	  ...
	  String sheetYearmakemodel	=	sheetYearStr+sheetMakeStr+sheetModelStr;
...
public void saveToFile(DataRow data,String fileName){
	...
	try {
		...
		String finalFileName	=	StringUtils.remove(fileName, ' ');
		mapper.writeValue(new File(baseFileDir+finalFileName+".json"), data);
